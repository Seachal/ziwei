...
public abstract class Part {
    ...
    protected void sendStart(OutputStream out) throws IOException {
        Log.error(TAG, "enter sendStart(OutputStream out)");
    ...
    protected void sendDispositionHeader(OutputStream out) throws IOException {
        Log.error(TAG, "enter sendDispositionHeader(OutputStream out)");
    ...
    protected void sendContentTypeHeader(OutputStream out) throws IOException {
        Log.error(TAG, "enter sendContentTypeHeader(OutputStream out)");
    ...
    protected void sendTransferEncodingHeader(OutputStream out) throws IOException {
        Log.error(TAG, "enter sendTransferEncodingHeader(OutputStream out)");
    ...
    protected void sendEndOfHeader(OutputStream out) throws IOException {
        Log.error(TAG, "enter sendEndOfHeader(OutputStream out)");
        out.write(CRLF_BYTES);
        out.write(CRLF_BYTES);
    }
    ...
    protected void sendEnd(OutputStream out) throws IOException {
        Log.error(TAG, "enter sendEnd(OutputStream out)");
        out.write(CRLF_BYTES);
    }
    ...
    public void send(OutputStream out) throws IOException {
        Log.error(TAG, "enter send(OutputStream out)");
        sendStart(out);
    ...
    public static long getLengthOfParts(Part[] parts, byte[] partBoundary) throws IOException {
        Log.error(TAG, "getLengthOfParts(Parts[])");
        if (parts == null) {
            throw new IllegalArgumentException("Parts may not be null");
        }
        long total = 0;
