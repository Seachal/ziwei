...
public class FilePart extends PartBase {
    ...
    protected void sendDispositionHeader(OutputStream out)
            throws IOException {
        Log.error("FilePart", "enter sendDispositionHeader(OutputStream out)");
    ...
    protected void sendData(OutputStream out) throws IOException {
        Log.error("FilePart", "enter sendData(OutputStream out)");
        if (lengthOfData() == 0) {

            // this file contains no data, so there is nothing to send.
            // we don't want to create a zero length buffer as this will
            // cause an infinite loop when reading.
            Log.error("FilePart", "No data to send.");
            return;
        }
    ...
    protected PartSource getSource() {
        Log.error("FilePart", "enter getSource()");
        return this.source;
    }
    ...
    protected long lengthOfData() {
        Log.error("FilePart", "enter lengthOfData()");
