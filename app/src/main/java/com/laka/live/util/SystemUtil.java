...
public class SystemUtil {
    ...
    public static int getScreenWidth(Activity context) {
        return context.getWindow().getWindowManager().getDefaultDisplay().getWidth();
    }
    ...
    public static int getScreenHeight(Activity context) {
        return context.getWindow().getWindowManager().getDefaultDisplay().getHeight();
    }
     ...
     */
    public static void dumpPhoneInfo(PrintWriter pw) throws PackageManager.NameNotFoundException {
        PackageManager pm = LiveApplication.getInstance().getPackageManager();
        PackageInfo pi = pm.getPackageInfo(LiveApplication.getInstance().getPackageName(), PackageManager.GET_ACTIVITIES);
