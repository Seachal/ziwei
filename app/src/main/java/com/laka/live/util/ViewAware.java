...
public abstract class ViewAware {
    ...
    public boolean setImageDrawable(Drawable drawable) {
        if(Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Log.error("Can\'t set a drawable into view. You should call ImageLoader on UI thread for it.", new Object[0].toString());
        }
    ...
    public boolean setImageBitmap(Bitmap bitmap) {
        if(Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Log.error("Can\'t set a bitmap into view. You should call ImageLoader on UI thread for it.", new Object[0].toString());
        }
