...
public class ThreadManager {
    ...
    /**
     * @param threadType           ThreadManager.THREAD_BACKGROUND or ThreadManager.THREAD_WORK
     *                             or ThreadManager.THREAD_UI or ThreadManager.THREAD_NORMAL
     * @param callbackToMainThread if true, preCallback and postCallback will run in UI thread;
     *                             if false, run in calling thread
     * @param preCallback          run before execute task runnable, control by
     *                             callbackToMainThread argument, can be null
     * @param postCallback         run after execute task runnable, control by
     *                             callbackToMainThread argument, can be null
     */
     ...
     * @param threadType           ThreadManager.THREAD_BACKGROUND or ThreadManager.THREAD_WORK
     *                             or ThreadManager.THREAD_UI or ThreadManager.THREAD_NORMAL
     * @param postCallbackRunnable run after execute task runnable, control by
     *                             callbackToMainThread argument, can be null
     */
