...
/**
 * Created by luwies on 16/7/25.
 */
public class LFGPUImageBeautyFilter extends GPUImageFilter {

    private static final String LF_GPU_IMAGE_BEAUTY_FRAGMENT_SHADER_STRING =
    ...
    public LFGPUImageBeautyFilter() {
        super(GPUImageFilter.NO_FILTER_VERTEX_SHADER, LF_GPU_IMAGE_BEAUTY_FRAGMENT_SHADER_STRING);
        mToneLevel = 0.5f;
        mBeautyLevel = 0.8f;
        mBrightLevel = 0.0f;
    }
    ...
    public void onOutputSizeChanged(int width, int height) {
        ...
        PointF pointF = new PointF(2.f / width, 2.f / height);
        setPoint(mSingleStepOffsetLocation, pointF);
    }
    ...
    public void setBrightLevel(float brightLevel) {
        ...
        setFloat(mBrightnessLocation, mBrightLevel);
    }

    public void setParams(float beauty, float tone) {
        float[] values = new float[4];
        values[0] = 1.0f - 0.6f * beauty;
        values[1] = 1.0f - 0.3f * beauty;
        values[2] = 0.1f + 0.3f * tone;
        values[3] = 0.1f + 0.3f * tone;
        setFloatVec4(mParamsLocation, values);
    }
}
