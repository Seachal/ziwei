...
//                    YUVNativeLibrary.YUVtoRBGA(data, previewSize.width, previewSize.height,
//                            mGLRgbBuffer.array());
                    int width = previewSize.width;
                    int height = previewSize.height;

                    LibYuv.convertNV21ToARGB(data, mGLRgbBuffer.array(), width, height);
    ...
    public void setByteBuffer(final ByteBuffer buffer, final int width, final int height) {
        if (buffer == null) {
            return;
        }
        runOnDraw(new Runnable() {
    ...
    public void setFlip(final boolean flipHorizontal, final boolean flipVertical) {
