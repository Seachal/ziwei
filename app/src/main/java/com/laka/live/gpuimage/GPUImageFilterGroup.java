...
import static com.laka.live.gpuimage.GPUImageRenderer.CUBE;
import static com.laka.live.gpuimage.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    public void replaceFilter(GPUImageFilter srcFilter, GPUImageFilter dstFilter) {
        int position = mFilters.indexOf(srcFilter);
        if (position < 0) {
            addFilter(dstFilter);
        } else {
            mFilters.set(position, dstFilter);
            updateMergedFilters();
        }
    }
