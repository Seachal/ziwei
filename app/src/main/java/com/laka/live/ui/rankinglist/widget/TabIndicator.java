...
public class TabIndicator extends View {
    ...
    /**
     * @param index current tab index, must be a valid index between [0,
     *              tabCount).
     */
     ...
     *
     * @param state can be NO_SCROLL, SCROLL_TO_LEFT_TAB, or SCROLL_TO_RIGHT_TAB.
     */
