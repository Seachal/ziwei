package com.laka.live.ui.widget.swipebacklayout;
...
public class SwipeBackActivityHelper {
	...
	public void onActivityCreate() {
		...
		mSwipeBackLayout = (SwipeBackLayout) LayoutInflater.from(mActivity)
				.inflate(R.layout.widget_swipeback_layout, null);
	...
	public void convertActivityFromTranslucent() {
		try {
			Method method = Activity.class.getDeclaredMethod(
					"convertFromTranslucent", (Class<?>) null);
			method.setAccessible(true);
			method.invoke(mActivity, (Object) null);
		} catch (Throwable t) {
		}
	}
