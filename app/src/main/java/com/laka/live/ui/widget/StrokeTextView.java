...
public class StrokeTextView extends TextView {
    ...
    public StrokeTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        strokeColor = a.getColor(R.styleable.StrokeTextView_stroke_border_color, 0);
        strokeWidth = a.getDimensionPixelSize(R.styleable.StrokeTextView_stroke_border_width, 0);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (strokeWidth > 0) {
            ...
            // 自定义描边效果
            strokePaint.setStyle(Paint.Style.STROKE);// 设置不同Style有不同效果哟 FILL_AND_STROKE
