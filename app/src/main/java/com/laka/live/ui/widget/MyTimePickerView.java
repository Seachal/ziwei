...
public class MyTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        ...
        //Option
        public MyTimePickerView.Builder setType(TimePickerView.Type type) {
            this.type = type;
            return this;
        }
    ...
    public void returnData() {
        ...
        if (timeSelectListener != null) {
            try {
                ...
                isCanDismiss = timeSelectListener.onTimeSelect(date, clickView);
    ...
    public interface OnTimeSelectListener {
        boolean onTimeSelect(Date date, View v);
    }
