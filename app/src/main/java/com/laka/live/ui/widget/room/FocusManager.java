...
public class FocusManager {
    private static final String TAG = "RoomFocusManager";
...
//    private ComboPreferences mPreferences;
    ...
    public FocusManager( String defaultFocusMode) {
//        mPreferences = preferences;
//        mDefaultFocusMode = defaultFocusMode;
        mDefaultFocusMode = Parameters.FOCUS_MODE_AUTO;
    ...
    public void initialize(View focusIndicatorRotate, View previewFrame,
            Listener listener, boolean mirror, int displayOrientation) {// FaceView faceView,
...
//        }
        ...
        int left =  clamp(x - focusWidth / 2, 0, previewWidth - focusWidth);
        int top =  clamp(y - focusHeight / 2, 0, previewHeight - focusHeight);
...
//        if (mFaceView != null) mFaceView.pause();
        ...
        //自动关闭焦点框
        mHandler.sendEmptyMessageDelayed(RESET_TOUCH_FOCUS, 2000);
    }
...
//                    CameraSettings.KEY_FOCUS_MODE, mDefaultFocusMode);
    ...
    public void updateFocusUI() {
        if (!mInitialized){
            com.laka.live.util.Log.d(TAG,"updateFocusUI !mInitialized");
            return;
        }
        com.laka.live.util.Log.d(TAG," updateFocusUI mState="+mState);
