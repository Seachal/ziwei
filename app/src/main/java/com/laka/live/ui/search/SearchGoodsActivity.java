...
import com.laka.live.msg.SearchGoodsMsg;
...
// 43
    private void init() {
        ...
        mSearchResult.setLayoutManager(new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL));
        mResultAdapter = new ShoppingGoodsAdapter(mContext);
        ...
        mSearchResult.setOnRequestCallBack(new PageListLayout.OnRequestCallBack() {
            ...
            public String request(int page, GsonHttpConnection.OnResultListener listener) {
                return DataProvider.searchGoods(mContext, mKeyword, page,SearchGoodsMsg.class,listener);
            }
        });
    ...
    private void handleOnSearchResultItemClick(int position) {
        ...
        ShoppingGoodsBaseBean goodsBaseBean = mResultAdapter.getItem(position);
    ...
    private void loadHotKeyword() {
        DataProvider.getSearchGoodsHotKeyword(new GsonHttpConnection.OnResultListener<SearchGoodsHotKeywordMsg>() {
            @Override
            public void onSuccess(SearchGoodsHotKeywordMsg msg) {
    ...
    private void handleOnRequestResultHotTagSuccess(SearchGoodsHotKeywordMsg msg) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.clear_button:
                AnalyticsReport.onEvent(SearchGoodsActivity.this, AnalyticsReport.EVENT_11001);
