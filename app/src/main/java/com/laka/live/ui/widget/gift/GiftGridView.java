...
public class GiftGridView extends RelativeLayout {
    ...
    private TextView mBalanceTv, tvRecharge;
    ...
    private void initUI() {
        view = (RelativeLayout) LayoutInflater.from(context).inflate(
                R.layout.layout_room_gift, null);
        mBalanceTv = (TextView) view.findViewById(R.id.tv_gift_kazuan);
    ...
    public void setListeners(OnClickListener listener, GiftGridListener giftListener, boolean isInRoom) {
        ...
        mBalanceTv.setOnClickListener(listener);
        ...
        if (!isInRoom) {
            ...
            mBalanceTv.setTextColor(ResourceHelper.getColor(R.color.color2E2E2E));
...
//        Log.d(TAG,"REFRESH_LAST_KAZUAN tvGiftKazuan.setText coins="+coins);
        mBalanceTv.setText(String.valueOf(coins)+"味豆");
    }
