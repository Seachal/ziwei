...
public class CircularProgressDrawable extends Drawable {
     ...
     * Color for the inner circle.
     */
    public int centerColorPressed;//按下颜色
    ...
    public void draw(Canvas canvas) {
        ...
        if(isPressed){
            paint.setColor(centerColorPressed);
        }else{
...
//        /**
//         * Color of the inner circle in #AARRGGBB mode. pressed
//         */
//        int centerColorPressed = R.color.color00AEFF;
