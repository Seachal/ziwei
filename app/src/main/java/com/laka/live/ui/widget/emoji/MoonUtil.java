...
public class MoonUtil {
	...
	public static final float SMALL_SCALE = 0.3F;//0.45F
	...
	/**
	 房间评论使用
	 */
	public static void identifyFaceExpressionRoom(Context context,
											  View textView, String value,String name,int align, float scale) {
		SpannableString mSpannableString = replaceEmoticons(context, value, scale, align);
		mSpannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#FFC773")),0,name.length()+1, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
		viewSetText(textView, mSpannableString);
	}
	...
	/**
	 房间评论使用
	 */
	public static SpannableString replaceEmoticons(Context context, String value,int align, float scale) {
		SpannableString mSpannableString = replaceEmoticons(context, value, scale, align);
