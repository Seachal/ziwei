        ...
        try {
            ...
            if (drawable.getIntrinsicWidth() <= 0 || drawable.getIntrinsicHeight() <= 0) {
                ...
                if (drawable instanceof RootDrawable) {
                    Drawable curentDrawable = drawable.getCurrent();
                    width = curentDrawable.getIntrinsicWidth();
                    height = curentDrawable.getIntrinsicHeight();
                }
                if (width <= 0 || height <= 0) {
                    width = COLORDRAWABLE_DIMENSION;
                    height = COLORDRAWABLE_DIMENSION;
                }
