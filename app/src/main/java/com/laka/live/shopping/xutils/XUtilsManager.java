...
package com.laka.live.shopping.xutils;
...
import com.laka.live.shopping.network.IDownLoadFileCallBack;
import com.laka.live.shopping.network.IHttpCallBack;
import com.laka.live.shopping.network.IHttpLoadingCallBack;
...
public class XUtilsManager implements IHttpManager {
    ...
    @Override
    public <T> T requestSync(String url, com.laka.live.shopping.network.HttpMethod httpMethod, Class<T> obj) {
    ...
    @Override
    public void request(String url,  com.laka.live.shopping.network.HttpMethod httpMethod, IHttpCallBack callBack) {
        request(url, httpMethod, null, callBack);
    }

    @Override
    public void requestWithLoading(String url,   com.laka.live.shopping.network.HttpMethod httpMethod, final
    IHttpLoadingCallBack callBack) {
        requestWithLoading(url, httpMethod, null, callBack);
    }

    @Override
    public <T> void requestWithLoading(String url,   com.laka.live.shopping.network.HttpMethod httpMethod, final Class<T> _obj,
        ...
        x.http().request(_httpMethod, mParams, new Callback.ProgressCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (StringUtils.isEmpty(result)) {
                    callBack.onError(result, HttpCode.ERROR_CODE_JSON_IS_EMPTY);
                    return;
                }
                int state;
                try {
    ...
    @Override
    public <T> void request(String url,   com.laka.live.shopping.network.HttpMethod httpMethod, final Class<T> _class, final
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (state == HttpCode.SUCCESS) {
                        ...
                        if (callBack != null) {
                            callBack.onError(jsonObject.getString("msg"), state);
                        }
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
    ...
    @Override
    public void setParams(String url, com.laka.live.shopping.network.HttpMethod httpMethod) {
