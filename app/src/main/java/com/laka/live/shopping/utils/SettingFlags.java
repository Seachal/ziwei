...
package com.laka.live.shopping.utils;
...
public class SettingFlags {
    ...
    public static void init(Context context) {
        sSharePreference = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
    }
    ...
    public static boolean containsFlag(String key) {
    ...
    public static void resetFlag(String key) {
