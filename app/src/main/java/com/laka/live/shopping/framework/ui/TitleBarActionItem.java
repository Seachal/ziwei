...
public class TitleBarActionItem extends FrameLayout {
    ...
    private void init() {
        int padding = ResourceHelper
                .getDimen(R.dimen.space_15);
        this.setPadding(padding, 0, padding, 0);
    }

    public void setTextDrawable(int leftResId, int rightResId) {
        Drawable leftDrawable = null;
        Drawable rightDrawable = null;
        if (leftResId > 0) {
            leftDrawable = ResourceHelper.getDrawable(leftResId);
        } else if (rightResId > 0) {
            rightDrawable = ResourceHelper.getDrawable(rightResId);
        }
        mTextView.setCompoundDrawablePadding(ResourceHelper.getDimen(R.dimen.space_5));
        mTextView.setCompoundDrawablesWithIntrinsicBounds(leftDrawable, null, rightDrawable, null);
    }
    ...
    private void initResource() {
        ...
        mTextView.setTextColor(ResourceHelper.getColor(R.color.color333333));
    ...
    private static class RedTipImageView extends FrameLayout {
        ...
        public RedTipImageView(Context context) {
            ...
            int padding = ResourceHelper.getDimen(R.dimen.space_6);
            mImageView.setPadding(padding, padding, padding, padding);
            this.addView(mImageView, lp);

            mTipsView = new TextView(context);
            mTipsView.setTextSize(TypedValue.COMPLEX_UNIT_PX, ResourceHelper.getDimen(R.dimen.space_11));
            ...
            lp.leftMargin = Utils.dip2px(getContext() , 15);
